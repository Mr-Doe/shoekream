			...
			<div class="container my lg" data-v-3d7f7af7>
				...
				<div data-fetch-key="OrderIndex:0" class="content_area"
					...
					<div class="my_purchase">
						...
						<div class="purchase_list_tab sell detail_tab" data-v-bbed98be>
							<!-- <div class="tab_item total" data-v-bbed98be>
								<a href="#" class="tab_link" data-v-bbed98be><dl
										...
										<dd class="count" data-v-bbed98be>${selDTO.totalCount}</dd>
									</dl></a>
							</div> -->
							...
							<div class="tab_item" data-v-bbed98be>
								<a href="#" class="tab_link" data-v-bbed98be><dl
										class="tab_box" data-v-bbed98be>
										<dt class="title" data-v-bbed98be>판매 입찰</dt>
										<dd class="count" data-v-bbed98be>${selDTO.bidCount}</dd>
									</dl></a>
							</div>
							<div class="tab_item" data-v-bbed98be>
								<a href="#" class="tab_link" data-v-bbed98be><dl
										...
										<dd class="count" data-v-bbed98be>${selDTO.endCount}</dd>
									</dl></a>
							</div>
						</div>
						<div class="purchase_list bidding ask" data-v-21d527e4>
								...
								<div class="head_status" data-v-21d527e4>
									<div class="status_box field_price" data-v-21d527e4>
										<a href="#" class="status_link" data-v-21d527e4><span
											class="status_txt" data-v-21d527e4>판매 희망가</span></a>
									</div>
							...
							<div class="empty_area" data-v-e2f6767a data-v-21d527e4>
								<c:choose>
									<c:when test="${selDTO.totalCount eq 0}">
										<p class="desc" data-v-e2f6767a>판매 입찰 내역이 없습니다.</p>
